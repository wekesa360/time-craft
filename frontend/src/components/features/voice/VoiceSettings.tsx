  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="ml-3 text-muted-foreground dark:text-muted-foreground">Loading settings...</span>
      </div>
    );
  }
      ...
      <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <input
                  ...
                  className="flex-1"
                />
                <span className="text-sm font-medium text-foreground dark:text-white min-w-[3rem]">
        ...
        <div className="bg-white dark:bg-muted rounded-lg p-6 border border-gray-200 dark:border-gray-600">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full px-4 py-3 bg-info text-white rounded-lg hover:bg-info transition-colors flex items-center justify-center gap-2"
            >
              <span>🎤</span>
        ...
        <div className="flex gap-3 pt-4">
          <button
            ...
            className="px-6 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:bg-muted transition-colors"
          >
