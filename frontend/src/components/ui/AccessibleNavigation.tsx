...
export const AccessibleNavigation: React.FC<AccessibleNavigationProps> = ({
  ...
  const toggleNavigation = () => {
    ...
    const message = language === 'de'
      ? `Navigation ${!isOpen ? 'geˆffnet' : 'geschlossen'}`
    ...
    <>
      ...
      {shouldCollapse && (
        <button
          ...
          aria-label={
            language === 'de'
              ? `Navigation ${isOpen ? 'schlieﬂen' : 'ˆffnen'}`
          ...
          <div className="flex items-center justify-between p-4 border-b border-border">
            ...
            {shouldCollapse && (
              <button
                ...
                aria-label={language === 'de' ? 'Navigation schlieﬂen' : 'Close navigation'}
              >
                <X className="w-5 h-5" aria-hidden="true" />
              </button>
            )}
      ...
      <div className="sr-only" aria-live="polite">
        {language === 'de' ? (
          ...
          ${shouldCollapse ? 'Escape zum Schlieﬂen.' : ''}`
        ) : (
