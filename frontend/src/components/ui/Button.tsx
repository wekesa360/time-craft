...
const buttonVariants = {
  ...
  secondary: 'bg-background-secondary hover:bg-background-tertiary text-foreground border-border',
  outline: 'border-border hover:bg-background-secondary text-foreground',
  ghost: 'hover:bg-background-secondary text-foreground border-transparent',
