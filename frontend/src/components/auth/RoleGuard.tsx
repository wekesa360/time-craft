...
const UnauthorizedFallback: React.FC<{ message: string }> = ({ message }) => (
  <div className="min-h-screen flex items-center justify-center bg-muted dark:bg-muted">
    <div className="max-w-md w-full bg-white dark:bg-muted rounded-lg shadow-lg p-8 text-center">
      <div className="w-16 h-16 mx-auto mb-4 bg-error-light dark:bg-error rounded-full flex items-center justify-center">
        <svg className="w-8 h-8 text-error dark:text-error-light" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
        </svg>
      </div>
      <h2 className="text-2xl font-bold text-foreground dark:text-white mb-2">Access Denied</h2>
      <p className="text-muted-foreground dark:text-muted-foreground mb-6">{message}</p>
      <button
