...
const getNavigationItems = (t: any) => [
  { name: t('navigation.dashboard'), href: '/dashboard', icon: LayoutDashboard, key: 'dashboard' },
  { name: t('navigation.tasks'), href: '/tasks', icon: CheckSquare, key: 'tasks' },
  { name: t('navigation.health'), href: '/health', icon: Heart, key: 'health' },
  { name: t('navigation.calendar'), href: '/calendar', icon: Calendar, key: 'calendar' },
    ...
    <div className="min-h-screen bg-background">
      ...
      {sidebarOpen && (
        <div 
          ...
          role="button"
          tabIndex={0}
          aria-label={i18n.language === 'de' ? 'Seitenleiste schließen' : 'Close sidebar'}
          onKeyDown={(e) => {
      ...
      <div 
        ...
        `}
        role="complementary"
        aria-label={i18n.language === 'de' ? 'Seitennavigation' : 'Sidebar navigation'}
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-border">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-lg font-semibold text-foreground">TimeCraft</span>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
          ...
          <GermanAccessibleNavigation 
            ...
            ariaLabel={i18n.language === 'de' ? 'Hauptnavigation' : 'Main navigation'}
          >
            {navigation.map((item) => {
      ...
      <div className="lg:pl-64">
        ...
        <header 
          ...
          role="banner"
          aria-label={i18n.language === 'de' ? 'Kopfzeile der Anwendung' : 'Application header'}
        >
          <div className="flex items-center justify-between h-16 px-6">
            <button
              onClick={() => setSidebarOpen(true)}
              className="lg:hidden btn-ghost p-2"
              aria-label={i18n.language === 'de' ? 'Seitenleiste öffnen' : 'Open sidebar'}
            ...
            <div className="flex items-center space-x-4" role="toolbar" aria-label={i18n.language === 'de' ? 'Benutzer-Werkzeugleiste' : 'User toolbar'}>
              ...
              <div className="relative">
                <button 
                  ...
                  aria-label={i18n.language === 'de' ? 'Benutzermenü öffnen' : 'Open user menu'}
                >
