...
export default function BadgesPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      {/* Header */}
      <div>
        <h1 className="text-3xl md:text-4xl font-bold text-foreground">Achievements & Badges</h1>
      ...
      <div className="bg-gradient-to-r from-primary to-primary/80 rounded-2xl p-6 md:p-8 text-primary-foreground">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            <p className="text-primary-foreground/80 mb-2">Total Points Earned</p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-sm">{Math.round((unlockedBadges / totalBadges) * 100)}% Complete</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {viewMode === 'badges' && (
        <div className="space-y-6">
                ...
                .map((badge) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-primary font-medium">
                      {badge.unlockedAt ? new Date(badge.unlockedAt).toLocaleDateString() : 'Recently earned'}
                    </p>
                  </div>
                ))}
          ...
          {/* All Badges Grid */}
          <div className="bg-card rounded-2xl p-6 border border-border">
            <h2 className="text-xl font-bold text-foreground mb-6">All Badges</h2>
      ...
      {viewMode === 'leaderboard' && (
        <div className="bg-card rounded-2xl p-6 border border-border">
          <h2 className="text-xl font-bold text-foreground mb-6">Badge Leaderboard</h2>
          <BadgeLeaderboard
      ...
      {viewMode === 'achievements' && (
        <div className="space-y-6">
          {/* Active Streaks */}
          <div className="bg-card rounded-2xl p-6 border border-border">
            <h2 className="text-xl font-bold text-foreground mb-6">Active Streaks</h2>
            ...
            <div className="grid md:grid-cols-2 gap-4">
                ...
                .map((badge, i) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="text-3xl font-bold text-foreground">{badge.progress.current}</p>
              ...
              {badges.filter(b => b.category === 'streak' && b.isUnlocked).length === 0 && (
                <>
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-white dark:bg-slate-800 border border-border">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-foreground">Daily Task Completion</p>
                      <p className="text-sm text-muted-foreground mt-1">Current streak</p>
                    </div>
                    <div className="text-right">
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-white dark:bg-slate-800 border border-border">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-foreground">Health Logging</p>
                      <p className="text-sm text-muted-foreground mt-1">Current streak</p>
                    </div>
                    <div className="text-right">
                      <p className="text-3xl font-bold text-foreground">0</p>
          ...
          <div className="bg-card rounded-2xl p-6 border border-border">
            ...
            {badges.filter(b => !b.isUnlocked && b.progress.percentage > 0).length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-muted-foreground">Complete more activities to start earning badges</p>
              </div>
            ) : (
              <div className="space-y-4">
                {badges
                  ...
                  .slice(0, 5)
                  .map((badge) => (
                    <div key={badge.id} className="flex items-center space-x-4 p-4 rounded-xl bg-white dark:bg-slate-800 border border-border">
